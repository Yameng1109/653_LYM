...
TOTAL=0         # The total number of test
PASSED=0        # The number of the passed tests

function verifyTest() {
  TESTNAME=$1     # The name of the test
  T_SUPPORT=$2    # The support number
  T_CONFIDENCE=$3    # The confidence number
